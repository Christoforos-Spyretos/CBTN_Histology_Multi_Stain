...
IM_CA_HE_inform_KI67_conch_v1_5_small_clam_sb = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/70%_split/LGG_vs_HGG/EVAL_LGG_vs_HGG_Intermediate_Fusion_CA_HE_inform_KI67_small_clam_sb_conch_v1_5.csv')
IM_CA_KI67_inform_HE_conch_v1_5_small_clam_sb = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/70%_split/LGG_vs_HGG/EVAL_LGG_vs_HGG_Intermediate_Fusion_CA_KI67_inform_HE_small_clam_sb_conch_v1_5.csv')
...
LF_AL_HE_KI67_conch_v1_5_small_clam_sb = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/70%_split/LGG_vs_HGG/EVAL_LGG_vs_HGG_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1_5.csv')
