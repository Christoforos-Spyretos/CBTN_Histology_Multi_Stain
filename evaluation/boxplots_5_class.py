...
legend = plt.legend(loc='upper center', bbox_to_anchor=(0.49, 1.2), ncol=3, fontsize=12.44, columnspacing=1.0, handletextpad=0.5)  # move legend higher to avoid overlap
...
new_legend_labels = [
    ...
    'Aggregation of Softmax Scores Late Fusion', 
