...
legend = plt.legend(handles, padded_labels, loc='upper center', bbox_to_anchor=(0.5, 1.26), ncol=4, fontsize=12.44, columnspacing=1.0, handletextpad=0.5, labelspacing=0.7)  # 4+4+4+1 layout
