...
# %% LOAD CSV
file_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/70%_split/LGG_vs_HGG/LGG_vs_HGG_summary.csv'
...
summary.to_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/70%_split/LGG_vs_HGG/LGG_vs_HGG_summary_table.csv', index=False)
# %%
