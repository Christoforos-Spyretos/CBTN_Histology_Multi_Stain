...
plt.savefig('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/LGG_vs_HGG/LGG_vs_HGG_BA_boxplot.png', bbox_inches='tight')
plt.show()
...
plt.xticks([])  # remove x-axis labels
plt.savefig('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/LGG_vs_HGG/LGG_vs_HGG_MCC_boxplot.png', bbox_inches='tight')
plt.show()
