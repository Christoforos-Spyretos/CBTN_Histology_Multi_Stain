...
# %% LOAD RESULTS
# path to results
results_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_Early_Fusion_HE_KI67_small_clam_sb_conch_v1'
...
save_name = 'EVAL_9_class_Early_Fusion_HE_KI67_small_clam_sb_conch_v1.csv'
