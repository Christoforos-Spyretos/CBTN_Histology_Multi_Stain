...
# %% LOAD RESULTS
# path to results
results_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/70%_split/LGG_vs_HGG/EVAL_LGG_vs_HGG_Intermediate_Fusion_CA_HE_inform_KI67_small_clam_sb_conch_v1_5'
...
for fold in folds:
    new_row = pd.DataFrame({
        ...
        'Fusion': ['Intermediate_Fusion_CA_HE_inform_KI67'],
        'Fold': [str(fold)],
        'BA': [0],
        'MCC': [0],
        'AUC': [0],
...
save_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/70%_split/LGG_vs_HGG'
os.makedirs(save_path, exist_ok=True)
save_name = 'EVAL_LGG_vs_HGG_Intermediate_Fusion_CA_HE_inform_KI67_small_clam_sb_conch_v1_5.csv'
