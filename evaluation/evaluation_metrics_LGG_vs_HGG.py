...
# %% LOAD RESULTS
# path to results
results_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/LGG_vs_HGG/EVAL_LGG_vs_HGG_KI67_small_clam_sb_conch_v1_5'
...
save_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/50%_split_0.5_training_drop/LGG_vs_HGG'
os.makedirs(save_path, exist_ok=True)
save_name = 'EVAL_LGG_vs_HGG_KI67_small_clam_sb_conch_v1_5.csv'
