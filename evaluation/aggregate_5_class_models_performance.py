...
IM_CA_HE_inform_KI67_conch_v1_5 = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/5_class/EVAL_5_class_Intermediate_Fusion_CA_HE_inform_KI67_small_clam_sb_conch_v1_5.csv')   
IM_CA_KI67_inform_HE_conch_v1_5 = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/5_class/EVAL_5_class_Intermediate_Fusion_CA_KI67_inform_HE_small_clam_sb_conch_v1_5.csv')
...
LF_LM_LL_HE_KI67_conch_v1_5 = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/5_class/EVAL_5_class_Late_Fusion_LM_LL_HE_KI67_small_clam_sb_conch_v1_5.csv')
LF_LM_OHL_HE_KI67_conch_v1_5 = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/5_class/EVAL_5_class_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1_5.csv')
LF_LM_THL_HE_KI67_conch_v1_5 = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/5_class/EVAL_5_class_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1_5.csv')
LF_LM_AL_HE_KI67_conch_v1_5 = pd.read_csv('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/5_class/EVAL_5_class_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1_5.csv')
...
summary = pd.concat([
    ...
    LF_LM_LL_HE_KI67_conch_v1_5,
    LF_LM_OHL_HE_KI67_conch_v1_5,
    LF_LM_THL_HE_KI67_conch_v1_5,
    LF_LM_AL_HE_KI67_conch_v1_5,
])
