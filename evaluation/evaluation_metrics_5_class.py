...
# %% LOAD RESULTS
# path to results
results_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_Late_Fusion_PA_HE_KI67_small_clam_sb_conch_v1_5'
...
save_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/evaluation/50%_split/5_class'
os.makedirs(save_path, exist_ok=True)
save_name = 'EVAL_5_class_Late_Fusion_PA_HE_KI67_small_clam_sb_conch_v1_5.csv'
