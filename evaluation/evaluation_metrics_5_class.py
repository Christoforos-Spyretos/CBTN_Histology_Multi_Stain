...
# %% LOAD RESULTS
# path to results
results_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/5_class/EVAL_5_class_Early_Fusion_KI67_only___abmil_uni2-h'
...
save_name = 'EVAL_5_class_Early_Fusion_KI67_only___abmil_uni2-h.csv'
