...
for fold in folds:
    ...
    Merged_HE_KI67_fold = pd.DataFrame({
        ...
        'p_1': p_1})
    # Define save path
    save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Late_Fusion/probs_aggregation/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_HE_KI67_small_clam_sb_conch/{fold}.csv'
...
for fold in folds:
    ...
    save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Late_Fusion/probs_aggregation/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_HE_GFAP_small_clam_sb_conch/{fold}.csv'
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
    # save results
...
for fold in folds:
    ...
    Merged_HE_KI67_GFAP_fold = pd.DataFrame({
        ...
        'p_1': p_1})
    # define the save path
    save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Late_Fusion/probs_aggregation/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_HE_KI67_GFAP_small_clam_sb_conch/{fold}.csv'
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
    # save results
