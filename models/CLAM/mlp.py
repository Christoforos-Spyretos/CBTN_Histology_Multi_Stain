...
# %% LOAD DATA & CONTENTS
# HE DATA & CONTENTS
Merged_HE_train = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Single_Stain_Train_Logits/small_clam_sb/uni/EVAL_5_class_Merged_HE_small_clam_sb_uni'
Merged_HE_val = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Single_Stain_Validation_Logits/small_clam_sb/uni/EVAL_5_class_Merged_HE_small_clam_sb_uni'
...
# KI67 DATA & CONTENTS
Merged_KI67_train = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Single_Stain_Train_Logits/small_clam_sb/uni/EVAL_5_class_Merged_KI67_small_clam_sb_uni'
Merged_KI67_val = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Single_Stain_Validation_Logits/small_clam_sb/uni/EVAL_5_class_Merged_KI67_small_clam_sb_uni'
...
# GFAP DATA & CONTENTS
Merged_GFAP_train = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Single_Stain_Train_Logits/small_clam_sb/uni/EVAL_5_class_Merged_GFAP_small_clam_sb_uni'
Merged_GFAP_val = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Single_Stain_Validation_Logits/small_clam_sb/uni/EVAL_5_class_Merged_GFAP_small_clam_sb_uni'
...
for fold in folds:
    if fold in X_train_folds and fold in X_val_folds:
        ...
        model_save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Late_Fusion/mlp/simple_model/small_clam_sb/uni/EVAL_5_class_Merged_HE_KI67_small_clam_sb_uni/fold_{fold}.pth'
...
for fold in folds:
    if fold in HE_train_folds_dict and fold in GFAP_train_folds_dict:
        HE_logits = HE_train_folds_dict[fold][['logits_0', 'logits_1']].values
        GFAP_logits = GFAP_train_folds_dict[fold][['logits_0', 'logits_1']].values
    ...
    if fold in HE_val_folds_dict and fold in GFAP_val_folds_dict:
        HE_logits = HE_val_folds_dict[fold][['logits_0', 'logits_1']].values
        GFAP_logits = GFAP_val_folds_dict[fold][['logits_0', 'logits_1']].values
        merged_logits = np.concatenate((HE_logits, GFAP_logits), axis=1)
        labels = HE_val_folds_dict[fold]['Y'].values
        X_val_folds[fold] = merged_logits
        y_val_folds[fold] = labels
...
for fold in folds:
    if fold in X_train_folds and fold in X_val_folds:
        ...
        # Save the model for each fold
        model_save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Late_Fusion/mlp/simple_model/small_clam_sb/uni/EVAL_5_class_Merged_HE_GFAP_small_clam_sb_uni/fold_{fold}.pth'
        if not os.path.exists(os.path.dirname(model_save_path)):
            os.makedirs(os.path.dirname(model_save_path))
        torch.save(model.state_dict(), model_save_path)
...
for fold in folds:
    if fold in X_train_folds and fold in X_val_folds:
        ...
        # Save the model for each fold
        model_save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments/5_class/Late_Fusion/mlp/simple_model/small_clam_sb/uni/EVAL_5_class_Merged_HE_KI67_GFAP_small_clam_sb_uni/fold_{fold}.pth'
        if not os.path.exists(os.path.dirname(model_save_path)):
            os.makedirs(os.path.dirname(model_save_path))
        torch.save(model.state_dict(), model_save_path)
