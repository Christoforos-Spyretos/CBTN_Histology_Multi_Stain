...
# paths to pt files
HE_features_path = "/local/data3/chrsp39/CBTN_v2/Learned_Subject_Level_Features/5_class/Merged_HE/features/conch_v1/pt_files"
KI67_features_path = "/local/data3/chrsp39/CBTN_v2/Learned_Subject_Level_Features/5_class/Merged_KI67/features/conch_v1/pt_files"
Merged_features_path = "/local/data3/chrsp39/CBTN_v2/Learned_Subject_Level_Features/5_class/Merged_HE_KI67/features/conch_v1/pt_files"
...
output_csv = '/local/data3/chrsp39/CBTN_v2/CSVs/Merged_HE_KI67_5_class_dataset_with_normalized_age.csv'
...
HE_output_path = "/local/data3/chrsp39/CBTN_v2/Learned_Subject_Level_Features/5_class/Merged_HE/features_with_age/conch_v1/pt_files"
KI67_output_path = "/local/data3/chrsp39/CBTN_v2/Learned_Subject_Level_Features/5_class/Merged_KI67/features_with_age/conch_v1/pt_files"
Merged_output_path = "/local/data3/chrsp39/CBTN_v2/Learned_Subject_Level_Features/5_class/Merged_HE_KI67/features_with_age/conch_v1/pt_files"
...
if len(HE_features_age) > 0:
    ...
    plot_tsne_with_age(HE_features_age, HE_labels_age, 
                       ...
                       'tSNE_HE_features_with_age_5_class.png')
...
if len(KI67_features_age) > 0:
    ...
    plot_tsne_with_age(KI67_features_age, KI67_labels_age,
                       ...
                       'tSNE_KI67_features_with_age_5_class.png')
...
if len(Merged_features_age) > 0:
    ...
    plot_tsne_with_age(Merged_features_age, Merged_labels_age,
                       ...
                       'tSNE_Merged_features_with_age_5_class.png')
