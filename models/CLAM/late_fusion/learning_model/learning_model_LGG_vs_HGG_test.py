...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_SL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        model.load_state_dict(torch.load(model_load_path))
        model.eval()
...
results_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/LGG_vs_HGG/EVAL_LGG_vs_HGG_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1'
if not os.path.exists(results_dir):
    os.makedirs(results_dir)
...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        model.load_state_dict(torch.load(model_load_path))
        model.eval()
...
print(f'Two Hidden Layer Model - Mean Test Loss: {mean_test_loss:.4f}')
print(f'Two Hidden Layer Model - Mean Test Accuracy: {mean_test_accuracy:.4f}')
print(f'Two Hidden Layer Model - Mean Test Balanced Accuracy: {mean_test_balanced_accuracy:.4f}')
print(f'Two Hidden Layer Model - Mean Test MCC: {mean_test_mcc:.4f}')
...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        model.load_state_dict(torch.load(model_load_path))
        model.eval()
