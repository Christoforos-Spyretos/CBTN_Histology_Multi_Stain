...
# %% LOAD DATA & CONTENTS
# HE DATA & CONTENTS
HE_train = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/EVAL_9_class_HE_train_logits_small_clam_sb_conch_v1_5'
HE_val = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/EVAL_9_class_HE_val_logits_small_clam_sb_conch_v1_5'
...
# KI67 DATA & CONTENTS
KI67_train = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/EVAL_9_class_KI67_train_logits_small_clam_sb_conch_v1_5'
KI67_val = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/EVAL_9_class_KI67_val_logits_small_clam_sb_conch_v1_5'
...
for fold in folds:
    if fold in HE_train_folds_dict and fold in KI67_train_folds_dict:
        # Extract raw logits
        HE_logits = HE_train_folds_dict[fold][['logits_0', 'logits_1', 'logits_2', 'logits_3', 'logits_4', 'logits_5', 'logits_6', 'logits_7', 'logits_8']].values
        KI67_logits = KI67_train_folds_dict[fold][['logits_0', 'logits_1', 'logits_2', 'logits_3', 'logits_4', 'logits_5', 'logits_6', 'logits_7', 'logits_8']].values
    ...
    if fold in HE_val_folds_dict and fold in KI67_val_folds_dict:
        HE_logits = HE_val_folds_dict[fold][['logits_0', 'logits_1', 'logits_2', 'logits_3', 'logits_4', 'logits_5', 'logits_6', 'logits_7', 'logits_8']].values
        KI67_logits = KI67_val_folds_dict[fold][['logits_0', 'logits_1', 'logits_2', 'logits_3', 'logits_4', 'logits_5', 'logits_6', 'logits_7', 'logits_8']].values
...
all_metrics_linear = {}
save_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_LL_HE_KI67_small_clam_sb_conch_v1_5'
...
save_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1_5'
hidden_dim = 15
...
save_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1_5'
hidden_dim1 = 15
hidden_dim2 = 10
...
save_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1_5'
