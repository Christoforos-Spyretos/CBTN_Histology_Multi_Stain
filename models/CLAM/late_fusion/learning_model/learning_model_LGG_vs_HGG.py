...
for fold in folds:
    if fold in X_train_folds and fold in X_val_folds:
        ...
        model_save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_SL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
...
if T > 0:
    ...
    plt.tight_layout()
    plt.savefig('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_SL_HE_KI67_small_clam_sb_conch_v1/plot_aggregate.png')
    plt.show()
...
for fold in folds:
    if fold in X_train_folds and fold in X_val_folds:
        ...
        # Save the model for each fold
        model_save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        if not os.path.exists(os.path.dirname(model_save_path)):
            os.makedirs(os.path.dirname(model_save_path))
        torch.save(model.state_dict(), model_save_path)
...
if T > 0:
    ...
    plt.tight_layout()
    plt.savefig('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1/plot_aggregate.png')
    plt.show()
...
for fold in folds:
    if fold in X_train_folds and fold in X_val_folds:
        ...
        # Save the model for each fold
        model_save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        if not os.path.exists(os.path.dirname(model_save_path)):
            os.makedirs(os.path.dirname(model_save_path))
        torch.save(model.state_dict(), model_save_path)
...
plt.tight_layout()
# save plot
plt.savefig('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1/plot.png')
plt.show()
...
if T > 0:
    ...
    plt.tight_layout()
    plt.savefig('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1/plot_aggregate.png')
    plt.show()
...
for fold in folds:
    if fold in X_train_folds and fold in X_val_folds:
        ...
        # Save the model for each fold
        model_save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        if not os.path.exists(os.path.dirname(model_save_path)):
            os.makedirs(os.path.dirname(model_save_path))
        torch.save(model.state_dict(), model_save_path)
...
if T > 0:
    ...
    plt.tight_layout()
    plt.savefig('/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/LGG_vs_HGG/LGG_vs_HGG_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1/plot_aggregate.png')
    plt.show()
