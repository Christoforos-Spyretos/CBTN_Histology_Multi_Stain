...
# %% LOAD & PREPARE DATA
# HE data & contents
HE_test = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_HE_small_clam_sb_conch_v1_5'
...
# KI67 data & contents
KI67_test = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_KI67_small_clam_sb_conch_v1_5'
...
test_metrics_single = test_model(
    ...
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/50%_split/5_class/5_class_Late_Fusion_LM_SL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_Late_Fusion_LM_SL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=5,
    verbose=True
)
...
test_metrics_one_hidden = test_model(
    ...
    slide_ids_folds=slide_ids_folds,
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/50%_split/5_class/5_class_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=5,
    hidden_dim=15,
    verbose=True
)
...
test_metrics_two_hidden = test_model(
    ...
    slide_ids_folds=slide_ids_folds,
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/50%_split/5_class/5_class_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=5,
    hidden_dim1=15,
    hidden_dim2=10,
    verbose=True
...
test_metrics_attention = test_model(
    ...
    slide_ids_folds=slide_ids_folds,
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/50%_split/5_class/5_class_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=5,
    verbose=True
)
