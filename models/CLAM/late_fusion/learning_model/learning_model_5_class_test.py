...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/5_class/5_class_Late_Fusion_LM_SL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        ...
        results = pd.DataFrame({
            ...
            'logits_2': outputs[:, 2].numpy(),
            'logits_3': outputs[:, 3].numpy(),
            'logits_4': outputs[:, 4].numpy()
        })
...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/5_class/5_class_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        model.load_state_dict(torch.load(model_load_path))
        model.eval()
...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/5_class/5_class_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        model.load_state_dict(torch.load(model_load_path))
        model.eval()
...
for fold in folds:
    if fold in X_test_folds:
        ...
        model_load_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/5_class/5_class_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1/{fold}.pth'
        model.load_state_dict(torch.load(model_load_path))
        model.eval()
