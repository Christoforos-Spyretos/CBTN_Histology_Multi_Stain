...
def test_model(
    ...
    for fold in folds:
        if fold in X_test_folds:
            ...
            # Add probabilities and logits for each class
            for i in range(n_classes):
                results_dict[f'p_{i}'] = probabilities[:, i]
                results_dict[f'logits_{i}'] = outputs[:, i].numpy()
...
# %% LOAD & PREPARE DATA
# HE data & contents
HE_test = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_HE_small_clam_sb_conch_v1_5'
...
# KI67 data & contents
KI67_test = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_KI67_small_clam_sb_conch_v1_5'
...
for fold in folds:
    if fold in HE_test_folds_dict and fold in KI67_test_folds_dict:
        HE_logits = HE_test_folds_dict[fold][['logits_0', 'logits_1', 'logits_2', 'logits_3', 'logits_4', 'logits_5', 'logits_6', 'logits_7', 'logits_8']].values
        KI67_logits = KI67_test_folds_dict[fold][['logits_0', 'logits_1', 'logits_2', 'logits_3', 'logits_4', 'logits_5', 'logits_6', 'logits_7', 'logits_8']].values
...
test_metrics_linear = test_model(
    ...
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_LL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_Late_Fusion_LM_LL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=9,
    verbose=True
)
...
test_metrics_one_hidden = test_model(
    ...
    slide_ids_folds=slide_ids_folds,
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_Late_Fusion_LM_OHL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=9,
    hidden_dim=15,
    verbose=True
)
...
test_metrics_two_hidden = test_model(
    ...
    slide_ids_folds=slide_ids_folds,
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_Late_Fusion_LM_THL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=9,
    hidden_dim1=15,
    hidden_dim2=10,
    verbose=True
...
test_metrics_attention = test_model(
    ...
    slide_ids_folds=slide_ids_folds,
    folds=folds,
    model_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/results/9_class/9_class_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1_5',
    results_dir='/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_Late_Fusion_LM_AL_HE_KI67_small_clam_sb_conch_v1_5',
    n_classes=9,
    verbose=True
)
