...
for fold in folds:
    ...
    Merged_HE_KI67_fold = pd.DataFrame({
        ...
        'p_4': p_4})
    # Define save path
    save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split/5_class/EVAL_5_class_Late_Fusion_PA_HE_KI67_small_clam_sb_conch_v1_5/{fold}.csv'
