...
for fold in folds:
    ...
    Merged_HE_KI67_fold = pd.DataFrame({
        ...
        'p_8': p_8})
    # Define save path
    save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/9_class/EVAL_9_class_Late_Fusion_PA_HE_KI67_small_clam_sb_conch_v1/{fold}.csv'
