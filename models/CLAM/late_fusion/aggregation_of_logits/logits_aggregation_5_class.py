...
# %% LOAD RESULTS
# path to results
Merged_HE_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split_0.5_training_drop/5_class/EVAL_5_class_HE_small_clam_sb_conch_v1_5'
Merged_KI67_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split_0.5_training_drop/5_class/EVAL_5_class_KI67_small_clam_sb_conch_v1_5'
...
for fold in folds:
    ...
    Merged_HE_KI67_fold = pd.DataFrame({
        ...
        'p_4': p_4})
    # define save path
    save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/50%_split_0.5_training_drop/5_class/EVAL_5_class_Late_Fusion_LA_HE_KI67_small_clam_sb_conch_v1_5/{fold}.csv'
