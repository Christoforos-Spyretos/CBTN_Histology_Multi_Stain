...
for fold in folds:
    ...
    # Define save path
    save_path = f'/local/data1/chrsp39/CBTN_Histology_Multi_Stain/models/CLAM/eval_results/EVAL_5_class_Late_Fusion_MJ_HE_KI67_small_clam_sb_conch_v1/{fold}.csv'
