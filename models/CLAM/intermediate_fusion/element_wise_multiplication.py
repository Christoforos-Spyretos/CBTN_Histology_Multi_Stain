...
@hydra.main(version_base="1.3.2", 
            ...
            config_name='element_wise_multiplication')
...
def main(cfg: DictConfig):
    ...
    for fold in range(n_folds):
        ...
        for subj_file in subjects:
            ...
            torch.save({'element_wise_mult': hadamard.cpu().numpy()}, save_path)
            print(f"Saved element-wise multiplication for {subj_file} in fold {fold} ({split_key})")
