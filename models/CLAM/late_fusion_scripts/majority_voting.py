...
# %% LOAD RESULTS
# path to results
Merged_HE_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Single_Stain/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_HE_small_clam_sb_conch'
Merged_KI67_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Single_Stain/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_KI67_small_clam_sb_conch'
Merged_GFAP_path = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Single_Stain/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_GFAP_small_clam_sb_conch'
...
for fold in folds:
    ...
    save_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Late_Fusion/majority_voting/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_HE_KI67_small_clam_sb_conch'
...
for fold in folds:
    ...
    GFAP_probs = GFAP_fold[['p_0', 'p_1']].values
    ...
    # ensure directory exists
    save_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Late_Fusion/majority_voting/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_HE_GFAP_small_clam_sb_conch'
    os.makedirs(save_dir, exist_ok=True)
    save_path = f'{save_dir}/{fold}.csv'
...
for fold in folds:
    ...
    # ensure directory exists
    save_dir = '/local/data1/chrsp39/CBTN_Histology_Multi_Modal/models/CLAM/Experiments_Evaluation/LGG_vs_HGG/Late_Fusion/majority_voting/small_clam_sb/conch/EVAL_LGG_vs_HGG_Merged_HE_KI67_GFAP_small_clam_sb_conch'
    os.makedirs(save_dir, exist_ok=True)
    save_path = f'{save_dir}/{fold}.csv'
