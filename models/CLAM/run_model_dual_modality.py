...
from utils.core_utils_dual_modality import train
from dataset_modules.dataset_generic import Generic_WSI_Classification_Dataset, Generic_MIL_Dataset_modality_1, Generic_MIL_Dataset_modality_2
...
@hydra.main(version_base="1.3.2", 
			...
			config_name='run_model_dual_modality')
...
def main(cfg:DictConfig):
    ...
    dataset_1 = Generic_MIL_Dataset_modality_1(csv_path = cfg.csv_path,
    ...
    dataset_2 = Generic_MIL_Dataset_modality_2(csv_path = cfg.csv_path,
    ...
    cfg.results_dir = os.path.join(cfg.results_dir, str(cfg.stain_dual_modality.exp_code) + '_s{}'.format(cfg.seed))
    if not os.path.isdir(cfg.results_dir):
        os.mkdir(cfg.results_dir)
