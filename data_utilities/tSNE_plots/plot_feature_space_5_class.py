...
for split_name in ['train', 'test']:
    ...
    path_to_learned_HE_features = f'/local/data3/chrsp39/CBTN_v2/SUBJECT_LEVEL_ATTENTION_HE/70%_split/5_class/features/conch_v1_5/{split_name}/pt_files/fold_12'
...
for split_name in ['train', 'test']:
    ...
    path_to_learned_KI67_features = f'/local/data3/chrsp39/CBTN_v2/SUBJECT_LEVEL_ATTENTION_KI67/70%_split/5_class/features/conch_v1_5/{split_name}/pt_files/fold_12'
    features_matrix, label_array, case_ids = collect_features_and_labels(
