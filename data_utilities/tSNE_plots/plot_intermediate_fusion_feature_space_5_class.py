...
#     if len(features) < 2:
#         print(f"Skipping PCA for '{title}': not enough samples ({len(features)})")
#         return
...
for split_name in ['train', 'test']:
    ...
    path_to_concat_features = f'/local/data3/chrsp39/CBTN_v2/SUBJECT_LEVEL_CONCATENATION_HE_KI67/70%_split/5_class/features/conch_v1_5/{split_name}/fold_12/pt_files'
    ...
    plot_tsne(features_matrix, label_array, f't-SNE of Concatenation H&E & Ki-67 Features ({split_name})',
              os.path.join(tsne_output_dir, f'tSNE_learned_Concatenation_HE_KI67_features_5_class_{split_name}.png'), labels_to_include)
...
for split_name in ['train', 'test']:
    ...
    path_to_elemwise_features = f'/local/data3/chrsp39/CBTN_v2/SUBJECT_LEVEL_ELEMENT_WISE_MULT_HE_KI67/70%_split/5_class/features/conch_v1_5/{split_name}/fold_12/pt_files'
    ...
    plot_tsne(features_matrix, label_array, f't-SNE of Element-wise Multiplication H&E & Ki-67 Features ({split_name})',
              os.path.join(tsne_output_dir, f'tSNE_learned_ElemWiseMult_HE_KI67_features_5_class_{split_name}.png'), labels_to_include)
...
for split_name in ['train', 'test']:
    ...
    path_to_he_cross_features = f'/local/data3/chrsp39/CBTN_v2/SUBJECT_LEVEL_CROSS_ATTENTION_HE_inform_KI67/70%_split/5_class/features/conch_v1_5/{split_name}/fold_12/pt_files'
    ...
    plot_tsne(features_matrix, label_array, f't-SNE of H&E-guided Cross Attention Features ({split_name})',
              os.path.join(tsne_output_dir, f'tSNE_learned_CrossAttn_HE_inform_KI67_features_5_class_{split_name}.png'), labels_to_include)
...
for split_name in ['train', 'test']:
    ...
    path_to_ki67_cross_features = f'/local/data3/chrsp39/CBTN_v2/SUBJECT_LEVEL_CROSS_ATTENTION_KI67_inform_HE/70%_split/5_class/features/conch_v1_5/{split_name}/fold_12/pt_files'
    ...
    plot_tsne(features_matrix, label_array, f't-SNE of Ki-67-guided Cross Attention Features ({split_name})',
              os.path.join(tsne_output_dir, f'tSNE_learned_CrossAttn_KI67_inform_HE_features_5_class_{split_name}.png'), labels_to_include)
