...
GFAP_example = '/local/data2/chrsp39/CBTN_v2/GFAP/WSI/C17466___7316-38___GFAP.svs'

HE_slide = openslide.OpenSlide(HE_example)
KI67_slide = openslide.OpenSlide(KI67_example)
GFAP_slide = openslide.OpenSlide(GFAP_example)
...
GFAP_region = GFAP_slide.read_region((0, 0), GFAP_slide.level_count - 1, GFAP_slide.level_dimensions[-1])
