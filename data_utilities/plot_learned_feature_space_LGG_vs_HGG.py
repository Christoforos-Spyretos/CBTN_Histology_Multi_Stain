...
plot_pca(features_matrix, label_array, 'PCA of Learned HE Features', 'PCA_learned_HE_features_LGG_vs_HGG.png', labels_to_include)
plot_tsne(features_matrix, label_array, 't-SNE of Learned HE Features', 'tSNE_learned_HE_features_LGG_vs_HGG.png', labels_to_include)
...
plot_pca(features_matrix, label_array, 'PCA of Learned KI67 Features', 'PCA_learned_KI67_features_LGG_vs_HGG.png', labels_to_include)
plot_tsne(features_matrix, label_array, 't-SNE of Learned KI67 Features', 'tSNE_learned_KI67_features_LGG_vs_HGG.png', labels_to_include)
...
plot_pca(features_matrix, label_array, 'PCA of Learned Early Fusion HE & KI67 Features', 'PCA_learned_Early_Fusion_features_LGG_vs_HGG.png', labels_to_include)
plot_tsne(features_matrix, label_array, 't-SNE of Learned Early Fusion HE & KI67 Features', 'tSNE_learned_Early_Fusion_features_LGG_vs_HGG.png', labels_to_include)
