...
plot_pca(features_matrix, labels, 'PCA of HE Features', os.path.join(pca_output_dir, 'PCA_raw_HE_features_5_class.png'))
plot_tsne(features_matrix, labels, 't-SNE of HE Features', os.path.join(tsne_output_dir, 'tSNE_raw_HE_features_5_class.png'))
...
plot_pca(features_matrix, labels, 'PCA of KI67 Features', os.path.join(pca_output_dir, 'PCA_raw_KI67_features_5_class.png'))
plot_tsne(features_matrix, labels, 't-SNE of KI67 Features', os.path.join(tsne_output_dir, 'tSNE_raw_KI67_features_5_class.png'))
...
plot_pca(features_matrix, labels, 'PCA of Merged HE & KI67 Features', os.path.join(pca_output_dir, 'PCA_raw_Merged_HE_KI67_features_5_class.png'))
plot_tsne(features_matrix, labels, 't-SNE of Merged HE & KI67 Features', os.path.join(tsne_output_dir, 'tSNE_raw_Merged_HE_KI67_features_5_class.png'))
